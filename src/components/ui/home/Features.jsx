...
function Features() {
  return (
    <div className="xl:h-screen flex w-screen xl:p-32 p-8 bg-background items-center flex-col">
      <div className="anton xl:text-8xl text-6xl text-main italic uppercase mb-4 text-center">
        What we Offer
      </div>
      <div className="hanken text-white xl:text-2xl text-xl text-center mb-8">
